...
#dsak;lg[jopsdakgfAPO[DGSJKA[IIJEJGF[SADJKG
MAIN_URL = "https://raw.githubusercontent.com/DjamBO121/esp32-pump-ota/refs/heads/main/main.py"#SDFSDFD
...
def check_integrity():
    try:
        ...
        print("!!! ОБНАРУЖЕН БИТЫЙ КОД !!!")
        if 'main.old' in os.listdir():
            print("Откат к предыдущей версии...")
            os.remove('main.py')
            os.rename('main.old', 'main.py')
        else:
            print("Критически: нет бэкапа для отката!")
